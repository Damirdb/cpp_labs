// реализовать проверку времени, чтобы можно было ввести допустимые значения/ реализовать ввод вреени через метод, чтобы он сам строил нужный формат чч:мм, а не пользователь вводил
#include <iostream>
#include <string>
#include <iomanip>
// #include <windows.h>
