...
public:
    ...
    virtual void input() {
        ...
        if (theme.empty()) {  // Если тематика не задана, запросить ввод
...
public:
    ...
    void input() override {
        theme = "Караоке";  // Автоматически устанавливаем тематику
        Club::input();
...
public:
    ...
    void input() override {
        theme = "Танцы";  // Автоматически устанавливаем тематику
        Club::input();
